    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header">
                <div class="mb-3">Inventory List</div>
            </div>
            <div class="card-body">
                <table class="table table-striped">
                    ...
                    @foreach($invantories as $key=>$invantory)
                    <tr>
                        <td>{{$key+1}}</td>
                        <td>{{$invantory->rel_to_color->color_name}}</td>
                        <td>{{$invantory->rel_to_size->size_name}}</td>
                        <td>{{$invantory->quantity}}</td>
