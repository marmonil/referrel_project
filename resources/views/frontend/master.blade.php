...
<body>
    ...
    <script type="text/javascript">
        ...
        (function() {
            ...
            s1.async = true;
            s1.src = 'https://embed.tawk.to/647c8ff87957702c744bafce/1h2394q91';
            s1.charset = 'UTF-8';
    ...
    <div class="body_wrap">
        ...
        ================================================== -->
        <header
            class="header_section {{ Route::CurrentRouteName() == 'index' ? 'header-style-no-collapse' : 'header-style-3' }}">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col col-lg-6 col-md-6 col-sm-12">
                            ...
                            <div class="advance_serach">
                                ...
                                <div class="form_item">
                                    <input type="search"id="search_input" name="search"
                    ...
                    <div class="row align-items-center">
                        <div class="col col-md-3">
                            <div class="allcategories_dropdown">
                                ...
                                <div class="{{ Route::CurrentRouteName() == 'index' ?: 'collapse' }}"
                                    id="allcategories_collapse">
                                    <div class="card card-body">
                                        <ul class="allcategories_list ul_li_block">
                                            @foreach (App\Models\category::all() as $category)
                                                <li><a href="shop_grid.html"><i class="icon icon-Starship"></i>
                                    ...
                                    @auth('customerlogin')
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                <li><a class="dropdown-item" href="{{ route('account') }}">profile</a>
                                                </li>
                                                <li><a class="dropdown-item" href="{{ route('customer.logout') }}">log
                                                        out</a></li>

                                            </ul>
                                        </div>
                                    @else
                                        <a href="{{ route('hobi.register') }}">Log in/Register</a>
                                    @endauth
                        ...
                        @foreach (App\Models\cart::where('customer_id', Auth::guard('customerlogin')->id())->get() as $cart)
                            <li>
                                ...
                                <div class="item_content">
                                    ...
                                    <span class="item_price">TK {{ $cart->rel_to_product->after_discount }}X
                                        {{ $cart->quantity }}</span>
                                </div>
