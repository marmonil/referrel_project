                                ...
                                <div class="coll-1">
                                    <div class="woocommerce-billing-fields">
                                        ...
                                        <p class="form-row form-row form-row-first validate-required"
                                            ...
                                            <input type="hidden" value="{{ Auth::guard('customerlogin')->id() }}"
                                                name="customer_id" />
                                        </p>
                                    ...
                                    <p class="form-row form-row notes" id="order_comments_field">
                                        ...
                                        <textarea name="notes" class="input-text " name="notes" id="order_comments" rows="2" cols="5"></textarea>
                                    </p>
                                </div>
                            </div>
                                ...
                                <table class="shop_table woocommerce-checkout-review-order-table">
                                    <tr class="cart-subtotal">
                                        ...
                                        <td><span class="woocommerce-Price-amount amount"><span
                                                    class="woocommerce-Price-currencySymbol">TK</span>{{ $sub_total }}</span>
                                        </td>
                                    </tr>
                                    <tr class="cart-subtotal">
                                        <th>Discount</th>
                                        <td><span class="woocommerce-Price-amount amount"><span
                                                    class="woocommerce-Price-currencySymbol">TK</span>{{ session('discount_final') }}</span>
                                        </td>
                                    </tr>
                                    <tr class="shipping">
                                        ...
                                        <td data-title="Shipping">
                                            ...
                                            <input
                                                type="hidden"id="delivery_charge"value="{{ $sub_total - session('discount_final') }}">
                                            <input
                                                type="hidden"name="discount_final"value="{{ session('discount_final') }}">
                                            <input type="radio" name="delivery" value="100"
                                                class="delivery_btn">Inside City </br>
                                            <input type="radio" name="delivery" value="200"
                                                class="delivery_btn">Outside City
                                        </td>
                                    </tr>
                                    <tr class="order-total">
                                        <th>Total</th>
                                        <td><strong><span class="woocommerce-Price-amount amount">TK</span>


                                                <span
                                                    id="total">{{ $sub_total - session('discount_final') }}</span></strong>
                                        </td>
                                    </tr>
                                </table>
...
@section('footer_script')
    ...
    <script>
        $('.delivery_btn').click(function() {
            ...
            var total = parseInt($('#delivery_charge').val());
