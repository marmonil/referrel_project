                            ...
                            @foreach ($all_products as $product)
                                <div class="col-lg-4 grid">
                                    ...
                                    <div class="details">
                                        ...
                                        <p><a href="{{ route('product.details', $product->slug) }}">{{ $product->short_desp }}
                                            </a></p>
                                        <div class="rating">
                                        ...
                                        <span class="price">
                                            <ins>
                                                <span class="woocommerce-Price-amount amount">
                                                    <bdi>
                                                        <span
                                                            class="woocommerce-Price-currencySymbol">tk</span>{{ $product->after_discount }}
                                                    </bdi>
                                                </span>
                                            </ins>
                                        </span>
                                    ...
                                    <div class="slider_item">
                                        <div class="small_product_layout">
                                            <a class="item_image" href="shop_details.html">
                                                <img src="{{ asset('uploads/product/preview') }}/{{ $best->rel_to_product->preview }}"
                                                    alt="image_not_found">
                                            </a>
                                            <div class="item_content">
                                                <h3 class="item_title">
                                                    <a
                                                        href="shop_details.html">{{ $best->rel_to_product->product_name }}</a>
                                                </h3>
            ...
            <div class="row newarrivals_products">
                ...
                <div class="col col-lg-7">
                    <div class="new-arrivals-grids clearfix">
                        @foreach ($new_arrivels as $new)
                            <div class="grid">
                                <div class="product-pic">
                                    <img src="{{ asset('uploads/product/preview') }}/{{ $new->preview }}" alt>
                                    <span class="theme-badge-2">{{ $new->discount }}% off</span>
                                </div>
                                <div class="details">
                                    <h4><a
                                            href="{{ route('product.details', $product->slug) }}">{{ $new->product_name }}</a>
                                    </h4>
                                    <p><a
                                            href="{{ route('product.details', $product->slug) }}">{{ $new->short_desp }}</a>
                                    </p>
                                    <span class="price">
                                        <ins>
                                            <span class="woocommerce-Price-amount amount">
            ...
            <div class="viewed_products_wrap arrows_topright">
                <div class="viewed_products_carousel row" data-slick='{"dots": false}'>
                    ...
                    @php
                        ...
                        $recentProducts = App\Models\Product::whereIn('id', $recentViewed)->get();
                    @endphp
                            ...
                            @foreach ($recentProducts as $recentProduct)
                                <div class="slider_item col">
                                    <div class="viewed_product_item">
                                        <div class="item_image">
                                            <img src="{{ asset('uploads/product/preview') }}/{{ $recentProduct->preview }}"
                                                alt="image_not_found">
                                        </div>
                                        <div class="item_content">
                                            <h3 class="item_title">Electronics</h3>
                                            <ul class="ul_li_block">
                                                <li><a href="#!">{{ $recentProduct->product_name }}</a></li>
                                                <li><a href="#!"> reguler
                                                        Price<del> {{ $recentProduct->product_price }} TK</del></a>
                                                </li>
                                                <li><a href="#!"> discount {{ $recentProduct->discount }} %TK</a>
                                                </li>
                                                <li><a href="#!">current
                                                        Price {{ $recentProduct->after_discount }} TK</a></li>
