                            ...
                            <div class="filter_sidebar">
                                <div class="fs_widget">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <input
                                                type="text"name="min"id="min"placeholder="min"class="form-control"
                                                value="{{ @$_GET['min'] }}">
                                        </div>
                                        <div class="col-lg-6">
                                            <input
                                                type="text"name="max"id="max"placeholder="max"class="form-control"
                                                value="{{ @$_GET['max'] }}">
                                        </div>
                                        <div class="col-lg-12 text-center mt-3">
                                            <button
                                                type="submit"class="btn btn-secondary rounded-0 form-control"id="range">submit</button>
                                        </div>
                                    </div>
                                            ...
                                            <li>
                                                <div class="checkbox_item">
                                                    <input id="category{{ $category->id }}"
                                                        class="category_id"type="radio" name="category"
                                                        value="{{ $category->id }}"
                                                        @if (isset($_GET['category'])) @if ($_GET['category'] == $category->id)
                                                            checked @endif
                                                        @endif
                                                    />
                                            ...
                                            <li>
                                                <div class="checkbox_item">
                                                    <input id="color{{ $color->id }}"
                                                        class="color_id"name="color"type="radio"
                                                        value="{{ $color->id }}"
                                ...
                                <div class="fs_widget">
                                    ...
                                    <ul class="fs_brand_list ul_li_block">
                                        @foreach ($sizes as $size)
                                            <li>
                                                <div class="checkbox_item">
                                                    <input id="size {{ $size->id }}" class="size_id" type="radio"
                                ...
                                <form action="#">
                                    <div class="select_option clearfix">
                                        <select class="sort">
                                            ...
                                            <option value="3">Sorting By Price(High-low)</option>
                                            <option value="4">Sorting By Size(low-high)</option>
                                        </select>
                                    </div>
                                </form>
                            </div>
...
@section('footer_script')
    <script>
        $('.search_btn').click(function() {
            ...
            var link = "{{ route('shop') }}" + "?q=" + search_input + "&category=" + category_id + "&color_id=" +
                color_id + "&size_id=" + size_id + "&min=" + min + "&max=" + max + '&sort=' + sort;
