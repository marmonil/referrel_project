                        ...
                        <div class="details_image_carousel">
                            @foreach ($thumbnails as $thumbnail)
                                <div class="slider_item">
                                    <img src="{{ asset('uploads/product/thumbnail') }}/{{ $thumbnail->thumbnail }}"
                                        alt="image_not_found">
                                </div>
                            @endforeach
                ...
                <div class="col-lg-6">
                    <div class="product_details_content">
                        ...
                        <div class="quantity_wrap">
                            ...
                            <div class="total_price">Total:TK <span
                                    id="total">{{ $product_info->first()->after_discount }}</span></div>
                        </div>
                        ...
                        <ul class="default_btns_group ul_li">
                            ...
                            @else
                                <li><a class="btn btn_primary addtocart_btn" href="{{ route('hobi.register') }}">Add To
                                        Cart</a></li>
                            @endauth
                        </ul>
                    </div>
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12 order-last">
                                    <div class="average_rating_text">
                                        ...
                                        <p class="mb-0">
                                            Average Star Rating: <span>{{ $avg }} out of 5</span>
                                            ({{ $total_review }} vote)
                                        </p>
                                    </div>
                                </div>
                            ...
                            @foreach ($reviews as $review)
                                <div class="customer_review_item clearfix">
                                    <div class="customer_image">
                                        <img src="{{ $review->rel_to_customer->profile_photo }}" alt="image_not_found">
                                    </div>
                            ...
                            @if (App\Models\orderProduct::where('customer_id', Auth::guard('customerlogin')->id())->where('product_id', $product_info->first()->id)->exists())
                                ...
                                @if (App\Models\orderProduct::where('customer_id', Auth::guard('customerlogin')->id())->where('product_id', $product_info->first()->id)->where('review', '!=', null)->first() == false)
                                    ...
                                    <div class="customer_review_form">
                                        ...
                                        <form action="{{ route('review') }}"method="POST">
                                            @csrf
                                            <input
                                                type="hidden"id="product_id"name="product_id"value="{{ $product_info->first()->id }}">
                                            <div class="form_item">
                                                <input type="text"
                                                    name="name"value="{{ Auth::guard('customerlogin')->user()->name }}">
                                            </div>
                                            <div class="form_item">
                                ...
                                @else
                                    <div class="alert alert-danger">
                                        <h2> You already reviewd in this product</h2>
                                    </div>
                                @endif
                            @else
                                <div class="alert alert-danger">
                                    <h2> you did not purchash this product .To review please purchash the product </h2>
                                </div>
                            @endif
                        @else
                            <div class="alert alert-danger">
                                <h2> To review This product please login first <a href="{{ Route('hobi.register') }}">Log in
                                        here</a></h2>
                            </div>
                        @endauth
                ...
                <div class="col-xs-12">
                    <div class="best-selling-products related-product-area">
                        ...
                        <div class="product-area clearfix">
                            @forelse($releted_product as $related)
                                <div class="grid">
                                    ...
                                    <div class="details">
                                        ...
                                        <p><a href=" {{ route('product.details', $related->slug) }}">{{ $related->short_desp }}
                                            </a></p>
                                        <div class="rating">
                                            ...
                                            <ins>
                                                <span class="woocommerce-Price-amount amount">
                                                    <bdi>
                                                        ...
                                                        <p><a href="#">{{ $related->after_discount }}</a></p>
...
@section('footer_script')
    <script>
        var quantiti = $('.input_number').val();
        $('.input_number_increment').click(function() {
            quantiti++
            $('.input_number').val(quantiti);
