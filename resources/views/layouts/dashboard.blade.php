            ...
            <div class="deznav-scroll">
                ...
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        ...
                        <li><a href="{{ Route('add.color.size') }}">Add Colors & Size</a></li>
                    </ul>
                </li>
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        <i class="flaticon-381-television"></i>
                        <span class="nav-text">Copun</span>
                    </a>
                    <ul aria-expanded="false">
                        <li><a href="{{ Route('copun') }}">Add copun</a></li>
                    </ul>
                </li>
                ...
                <li><a class="has-arrow ai-icon" href="{{ route('products') }}" aria-expanded="false">
                        <i class="flaticon-381-television"></i>
                        <span class="nav-text">Products</span>
                    </a>
